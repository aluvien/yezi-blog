    ...
    <div className="w-full min-w-0 sm:w-[24rem]">
      <div className="flex items-start gap-2">
        <button
          ...
          onClick={sync}
          disabled={pending}
          className="inline-flex h-10 min-w-[7rem] shrink-0 items-center justify-center whitespace-nowrap rounded-lg border border-neutral-300 px-3 text-sm text-neutral-700 transition-colors hover:border-neutral-900 hover:text-neutral-900 disabled:cursor-wait disabled:opacity-50"
        >
