...
export type MarkdownTool =
  ...
  | { kind: "link" | "image" | "music" | "video" | "reference"; label: string; title: string }
...
const LIST_TOOL = { kind: "line-prefix", label: "列表", title: "将选中行设为列表", prefix: "- ", placeholder: "列表项" } as const;
...
export const STANDARD_MARKDOWN_TOOLS = [
  H2_TOOL, BOLD_TOOL, ITALIC_TOOL, LINK_TOOL, QUOTE_TOOL, LIST_TOOL, CODE_TOOL, IMAGE_TOOL, MUSIC_TOOL, VIDEO_TOOL, DIVIDER_TOOL,
...
export const ARTICLE_MARKDOWN_TOOLS = [
  ...
  QUOTE_TOOL, LIST_TOOL, CODE_TOOL, IMAGE_TOOL, MUSIC_TOOL, VIDEO_TOOL, DIVIDER_TOOL,
] as const satisfies readonly MarkdownTool[];
